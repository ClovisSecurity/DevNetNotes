...
##
## To find documentation on the meraki sdk go to the pip page for documentation
##
...
# Get Orgs - This is the top level classification we filter by
...
# Get Networks in Org - We get organizations because everything is done by orgId
params = {}
