...
pol_url = '/api/fmc_config/v1/domain/e276abec-e0f2-11e3-8169-6d9ed49b625f/policy/accesspolicies' # from API Explorer

payload = {
    "type": "AccessPolicy",
    "name": "CBT Policy",                                # Can be anything I want
    ...
    "defaultAction": {
        ...
        "logBegin": False,
        "logEnd": True,
        "sendEventsToFMC": True                             # When this policy triggers an event, send to FMC 
    }
}
...
rules_payload = {
    ...
    "action": "ALLOW",                   # ALLOW the traffic 
    "enabled": True,
    "type": "AccessRule",                # Object Type
    ...
    "filePolicy": {
        "name": "New Malware",               # Creating new Firepower malware scanning policy called "New Malware"
